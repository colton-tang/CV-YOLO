...
Usage:
    python tools/inference_world.py --source path/to/image.jpg --classes "person,car,dog"
    python tools/inference_world.py --source path/to/video.mp4 --classes "person,car" --save
"""
